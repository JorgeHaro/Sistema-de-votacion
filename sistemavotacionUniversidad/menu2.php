...
if (isset($_POST["boton"])) {
	...
	switch ($boton) {
		...
		$codigo_candidato_hash=password_hash($municipio,PASSWORD_DEFAULT);
           
		$sql="update alumnos set voto='1', cod_candidato='$codigo_candidato_hash' where cedula_Alumno='$cedula'";
