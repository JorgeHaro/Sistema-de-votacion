...
if (isset($_POST["boton"])) {
	...
	?>
			...
			<script>
			alert('Por favor colocar solo código UNI');
			</script>
			<?php
...
<fieldset>
							<legend><em><strong><font color="white" >Seleccione su especialidad</font></strong></em></legend>
						<?php
					...
					<br>
  <div class="form-group">
    <label for="Usuario"><font color="white" size="4">Código UNI</font></label>
    <input type="password" name="cedula" class="form-control" id="cedula" placeholder="password" required>
  </div>
  <div class="form-group">
    <label for="ejemplo_password_1"><font color="white" size="4"><center>Nombre y apellido</center></font></label>
    <input type="text" name="nombre" class="form-control" id="nombre"  placeholder="Ejemplo:Enrique Sandoval Serveleon" required>
  </div>
